...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
            ...
            { text: "Releases", link: "/release/release_main" },
            ...
            "/documentation/": [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: "Accelerate Fit", collapsed: true, items: [{ text: "Speed up for large datasets", link: "documentation/fit/accelerate/speed_up_large_datasets" }] },
                        {
                            text: "Plots",
                            collapsed: true,
                            items: [
                    ...
                    items: [
                        {
                            ...
                            collapsed: true,
                            items: [
                                { text: "Own Distribution", link: "/documentation/simulation/queue_simulation/own_distribution" },
                                { text: "Create Queue Simulation Instance", link: "/documentation/simulation/queue_simulation/create_queue_instance" },
                                { text: "Run Queue Instance", link: "/documentation/simulation/queue_simulation/run_queue_simulation" },
                                { text: "Queue Simulation Metrics", link: "/documentation/simulation/queue_simulation/queue_metrics" },
                                { text: "Queue Simulation Probabilities", link: "/documentation/simulation/queue_simulation/queue_probabilities" },
                                { text: "Confidence Interval for Simulation Metrics", link: "/documentation/simulation/queue_simulation/queue_confidence_interval" },
                            ],
                        },
                        {
                            ...
                            collapsed: true,
                            items: [
                                { text: "Create Instance Simulation", link: "/documentation/simulation/process_simulation/create_instance_simulation" },
                                { text: "Create a Process Simulation", link: "/documentation/simulation/process_simulation/create_process" },
                                { text: "Graph Process Simulation", link: "/documentation/simulation/process_simulation/graph_process" },
                                { text: "Run a Process Simulation", link: "/documentation/simulation/process_simulation/run_simulation" },
                                { text: "Simulation Metrics", link: "/documentation/simulation/process_simulation/simulation_metrics" },
                                { text: "Confidence Interval of Metrics", link: "/documentation/simulation/process_simulation/confidence_interval" },
                            ],
                        },
                    ],
                },
        ...
        socialLinks: [
            ...
            { icon: "youtube", link: "https://github.com/phitterio/phitter-kernel" },
            { icon: "x", link: "https://github.com/phitterio/phitter-kernel" },
        ],
    },
    markdown: {
        math: true,
